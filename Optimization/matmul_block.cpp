...
int main(int argc, char **argv) {
    ...
    const int N = std::atoi(argv[2]); // Dimension of the matrices, try larger values like 512 or 1024 to see performance difference
    const int BLOCK_SIZE = std::atoi(argv[3]); // Dimension of the blocks
...
// parallel "g++ matmul_block.cpp -o matmul_block{}.x" ::: 0 1 2 3 fast
// parallel "./matmul_block{1}.x 10 1024 {2} >> data_{1}.txt" ::: 0 1 2 3 fast ::: 2 4 8 16 32 64 128 256 512 1024
// parallel "sort -nk 2 data_{}.txt > data-{}.txt" ::: 0 1 2 3 fast